...
//!     -- --ignored --nocapture --test-threads=1 stress::stress_trade_burst
//! ```
//!
//! All scenarios under nextest for process isolation:
//!
//! ```bash
//! cargo nextest run --release -p nautilus-live --test integration \
//!     --run-ignored=ignored-only stress::
//! ```
//!
...
//!     -p nautilus-live --test integration -o target/flamegraph/trade_burst.svg \
//!     -- --ignored --nocapture --test-threads=1 stress::stress_trade_burst
//! ```
